    ...
    <div className="grid grid-cols-7 gap-6 p-6">
      ...
      <div className="col-span-5">
        {informasiLeft.map((item, index) => (
          <div
            key={index}
            className="card lg:card-side bg-base-100 shadow-xl h-80"
          >
            <figure>
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <a
                  ...
                  className="mt-6 px-8 py-3 bg-[rgb(48,134,98)] hover:bg-[rgb(97,197,165)] text-white font-semibold rounded-lg shadow-lg transition flex items-center gap-2"
                >
